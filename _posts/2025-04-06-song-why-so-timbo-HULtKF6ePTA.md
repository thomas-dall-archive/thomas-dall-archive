...
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; background: #000; border-radius: 8px; border: 1px solid #333;">
  <iframe src="https://www.youtube.com/embed/HULtKF6ePTA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>

### Video Information
**Source Link:** [Watch on YouTube](https://www.youtube.com/watch?v=HULtKF6ePTA)
**Channel:** Roboto San

### Description
{% raw %}
​@PotatoOfLife Heard you prompt AI about nicknames you don't like, just in case you're wondering why we won't call you by your preferred name. Hint: You can't resurrect a dead career under a new name.
